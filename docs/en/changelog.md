...
- chore(version): bump version to v3.0.0
...
- fix: resolve tailscaled crash on devices without FPU or TUN support
- chore(script): delete version comment
- feat: add self-update functionality to the script with optional force check

## v2.3.0 (2026-03-08)

- fix: update version to 2.3.1 and improve architecture handling in download script

## v2.2.1 (2026-01-28)

- feat: update version to 2.3.0 and add support for armv6 and armv5 architectures
...
- feat: add script self-update functionality
...
- feat: enhance tailscale-manager with small binary support
